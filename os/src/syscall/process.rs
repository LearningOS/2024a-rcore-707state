...
use crate::{
    ...
    task::{
        exit_current_and_run_next, increase_syscall_number, suspend_current_and_run_next,
...
pub fn sys_exit(exit_code: i32) -> ! {
    ...
    increase_syscall_number(SYSCALL_EXIT);
...
pub fn sys_yield() -> isize {
    ...
    increase_syscall_number(SYSCALL_YIELD);
